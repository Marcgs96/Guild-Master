...
namespace NodeCanvas.Framework
{
	...
	abstract public class GraphOwner : MonoBehaviour
    {
        ...
        [HideInInspector] ///When will the first activation be (if EnableBehaviour at all)
		public FirstActivation firstActivation = FirstActivation.OnEnable;
        ...
        ///Raised when "Start" is called, then is set to null
        ...
        public void StartBehaviour(bool autoUpdate, System.Action<bool> callback = null) {
        ...
        protected void Start() {
            ...
            //since "Start" is called once anyway we set event to null to avoid unsub requirements
    ...
    abstract public class GraphOwner<T> : GraphOwner where T : Graph
    {
        ...
        public void StartBehaviour(T newGraph, bool autoUpdate, System.Action<bool> callback = null) {
        ...
        ///Use to switch or set graphs at runtime and optionaly get a callback when it's finished if at all
        public void SwitchBehaviour(T newGraph, bool autoUpdate, System.Action<bool> callback = null) {
            StopBehaviour();
            graph = newGraph;
