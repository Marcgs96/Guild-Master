...
namespace NodeCanvas.Framework
{
    ...
    abstract public partial class Graph : ScriptableObject, ITaskSystem, ISerializationCallbackReceiver
    {
        ...
        ///Start the graph for the agent and blackboard provided, autoUpdated or not.
        ...
        public void UpdateGraph() {
            ...
            if ( isRunning ) {
                ...
                Logger.LogWarning("UpdateGraph called in a non-running graph. StartGraph() or StartBehaviour() should be called first.", "Execution", this);
            }
        ...
        ///Get ALL Tasks of type T in the graph (including tasks assigned on Nodes and on Connections and other Tasks that fetched through ISubTasksContainer).
