...
namespace NodeCanvas.Editor
{
    ...
    public static class BlackboardEditor
    {
        ...
        private static GUILayoutOption[] layoutOptions = new GUILayoutOption[] { GUILayout.MaxWidth(100), GUILayout.ExpandWidth(true) };
        ...
        static object VariableField(Variable data, UnityEngine.Object context, GUILayoutOption[] layoutOptions) {
            ...
            if ( typeof(UnityEngine.Object).IsAssignableFrom(t) || t.IsInterface ) {
                ...
                try { return EditorGUILayout.ObjectField((UnityEngine.Object)o, t, isSceneObjectType, layoutOptions); }
                catch { /*this is just in variable is interface and no unityobject*/ }
            }
