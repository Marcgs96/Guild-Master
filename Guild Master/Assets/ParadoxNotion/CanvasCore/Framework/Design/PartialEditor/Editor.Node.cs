            ...
            if ( !node.showIcon || node.iconAlignment != Alignment2x2.Default ) {
                if ( node.name != null ) {
                    ...
                    if ( node.nodeColor != default(Color) ) {
                        ...
                        hex = EditorGUIUtility.isProSkin ? node.hexColor : DEFAULT_HEX_COLOR_DARK;
                    }
                    ...
                    GUILayout.Label(content, StyleSheet.windowTitle, image != null ? GUILayout.MaxHeight(23) : GUILayout.Height(23));
                }
            }
