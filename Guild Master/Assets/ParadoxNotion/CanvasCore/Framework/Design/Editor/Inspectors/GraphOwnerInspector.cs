...
namespace NodeCanvas.Editor
{
    ...
    public class GraphOwnerInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI() {
            ...
            owner.firstActivation = (GraphOwner.FirstActivation)EditorGUILayout.EnumPopup("First Activation", owner.firstActivation);
            ...
            if ( Application.isPlaying && owner.graph != null && !ownerPeristant ) {
                ...
                GUI.color = Color.white.WithAlpha(owner.isRunning || owner.isPaused ? 1f : 0.6f);
                ...
                GUI.color = Color.white.WithAlpha(owner.isPaused ? 1f : 0.6f);
