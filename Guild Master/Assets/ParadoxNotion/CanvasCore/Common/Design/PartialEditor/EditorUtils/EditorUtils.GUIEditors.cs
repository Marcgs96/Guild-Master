...
namespace ParadoxNotion.Design
{
	...
	partial class EditorUtils
    {
        ...
        public static string StringPopup(GUIContent content, string selected, List<string> options, params GUILayoutOption[] GUIOptions) {
        ...
        public static T Popup<T>(T selected, List<T> options, params GUILayoutOption[] GUIOptions) {
