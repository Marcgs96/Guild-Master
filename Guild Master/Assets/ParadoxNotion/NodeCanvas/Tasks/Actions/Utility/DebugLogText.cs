        ...
        protected override void OnExecute() {
            if ( verboseMode == VerboseMode.LogAndDisplayLabel || verboseMode == VerboseMode.LogOnly ) {
                ...
                if ( logMode == LogMode.Log ) {
                    ParadoxNotion.Services.Logger.Log(label, "Execution", this);
                }
                if ( logMode == LogMode.Warning ) {
                    ParadoxNotion.Services.Logger.LogWarning(label, "Execution", this);
                }
                if ( logMode == LogMode.Error ) {
                    ParadoxNotion.Services.Logger.LogError(label, "Execution", this);
                }
            }
