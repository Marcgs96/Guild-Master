    ...
    public class SubDialogueTree : DTNode, IGraphAssignable, ISubParametersContainer
    {
        ...
        protected override void OnNodeInspectorGUI() {
            ...
            if ( subTree == this.DLGTree ) {
                ParadoxNotion.Services.Logger.LogWarning("Nested DialogueTree can't be itself. Please select another.", "Editor", this);
                subTree = null;
            }
        ...
        void ShowVariablesMapping() {
            ...
            UnityEditor.EditorGUILayout.HelpBox("You can set the SubDialogueTree's variables if any, by mapping them to the variables of this Dialogue Tree. If set to 'NONE', the variable will not be affected.", UnityEditor.MessageType.Info);
