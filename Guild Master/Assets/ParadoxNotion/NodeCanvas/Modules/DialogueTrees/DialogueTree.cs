...
namespace NodeCanvas.DialogueTrees
{
    ...
    public class DialogueTree : Graph
    {
        ...
        public IDialogueActor GetActorReferenceByName(string paramName) {
            ...
            Logger.Log(string.Format("<b>DialogueTree:</b> An actor entry '{0}' on DialogueTree has no reference. A dummy Actor will be used with the entry Key for name", paramName), "Execution", this);
        ...
        public void SetActorReference(string paramName, IDialogueActor actor) {
            ...
            if ( param == null ) {
                Logger.LogError(string.Format("There is no defined Actor key name '{0}'", paramName), "Execution", this);
                return;
            }
            param.actor = actor;
        }
        ...
        public void SetActorReferences(Dictionary<string, IDialogueActor> actors) {
            foreach ( var pair in actors ) {
                ...
                if ( param == null ) {
                    Logger.LogWarning(string.Format("There is no defined Actor key name '{0}'. Seting actor skiped", pair.Key), "Execution", this);
                    continue;
                }
        ...
        public static void RequestSubtitles(SubtitlesRequestInfo info) {
            ...
            else Logger.LogWarning("<b>DialogueTree:</b> Subtitle Request event has no subscribers. Make sure to add the default '@DialogueGUI' prefab or create your own GUI.");
        }
        ...
        public static void RequestMultipleChoices(MultipleChoiceRequestInfo info) {
            ...
            else Logger.LogWarning("<b>DialogueTree:</b> Multiple Choice Request event has no subscribers. Make sure to add the default '@DialogueGUI' prefab or create your own GUI.");
        }
        ...
        protected override void OnGraphStarted() {
            ...
            Logger.Log(string.Format("<b>DialogueTree:</b> Dialogue Started '{0}'", this.name), "Execution", this);
            if ( OnDialogueStarted != null ) {
                OnDialogueStarted(this);
            }

            if ( !( agent is IDialogueActor ) ) {
                Logger.Log("<b>DialogueTree:</b> INSTIGATOR agent used in DialogueTree does not implement IDialogueActor. A dummy actor will be used.", "Execution", this);
            }
        ...
        protected override void OnGraphUnpaused() {
            ...
            Logger.Log(string.Format("<b>DialogueTree:</b> Dialogue Resumed '{0}'", this.name), "Execution", this);
            if ( OnDialogueStarted != null ) {
                OnDialogueStarted(this);
            }
        }
        ...
        protected override void OnGraphStoped() {
            ...
            Logger.Log(string.Format("<b>DialogueTree:</b> Dialogue Finished '{0}'", this.name), "Execution", this);
        ...
        protected override void OnGraphPaused() {
            ...
            Logger.Log(string.Format("<b>DialogueTree:</b> Dialogue Paused '{0}'", this.name), "Execution", this);
