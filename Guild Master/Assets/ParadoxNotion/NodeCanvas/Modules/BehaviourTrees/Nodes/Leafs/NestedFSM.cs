...
namespace NodeCanvas.BehaviourTrees
{
    ...
    public class NestedFSM : BTNode, IGraphAssignable
    {
        ...
        protected override void OnNodeInspectorGUI() {
            ...
            successState = EditorUtils.Popup<string>("Success State", successState, nestedFSM.GetStateNames().ToList());
            failureState = EditorUtils.Popup<string>("Failure State", failureState, nestedFSM.GetStateNames().ToList());
